      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="hidden lg:flex bg-white dark:bg-zinc-900 border-b border-ink-100 dark:border-zinc-800 h-16 items-center justify-between px-8 flex-shrink-0">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm text-ink-400 dark:text-zinc-500 font-medium">Pages</span>
            <span className="text-sm text-ink-300 dark:text-zinc-650">/</span>
          ...
          <div className="flex items-center gap-5">
            {/* Notification bell */}
            <button className="p-2 text-ink-500 dark:text-zinc-400 hover:bg-ink-50 dark:hover:bg-zinc-800 rounded-xl transition-colors relative">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
              </svg>
              <span className="absolute top-2 right-2 w-1.5 h-1.5 bg-[#4a7c59] rounded-full" />
            </button>
